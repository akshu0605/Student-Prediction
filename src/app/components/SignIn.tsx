  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 rounded-full blur-3xl"
      />
      <motion.div
        animate={{
          y: [0, 15, 0],
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded bg-black/50 border-gray-800 text-blue-500 focus:ring-0 focus:ring-offset-0"
                />
